...
export function AddModel() {
  ...
  const onFinish = async (v) => {
    ...
    return;
    try {
      const res = await Api.UserController.submitModel(params as any);

      console.log(res, 'res=====', res?.data?.img, 'imgurl', res?.data);
      if (res?.status === 'ok') {
        setUrl(res?.data?.img);
      }
    } catch (error) {}
    ...
    <>
      ...
      >
                      ...
                      if (boxName) {
                        ...
                        return (
                          <div style={{ display: 'flex', width: '720px' }}>
                            ...
                            <Col>
                              <ProFormDigit label="箱子数量" name="boxNum" width="sm" />
                            </Col>
                          </div>
                        );
                      } else {
                        return (
                          <div style={{ display: 'inline-flex', flexWrap: 'wrap' }}>
                            <ProFormDigit name="boxLength" label="宽度" width="sm" />
                            <ProFormDigit name="boxWidth" label="高度" width="sm" />
                            <ProFormDigit name="boxHeight" label="深度" width="sm" />
                            <ProFormDigit label="箱子数量" name="boxNum" width="sm" />
                          </div>
                        );
                      }
        ...
        >
          ...
          >
            <ProForm.Group>
              <ProFormDigit name="frontLength" label="宽度" width="sm" />
              <ProFormDigit name="frontWidth" label="高度" width="sm" />
              <ProFormDigit name="frontHeight" label="深度" width="sm" />
            </ProForm.Group>
          </ProCard>
          {/* container */}
          <ProCard
          ...
          >
            <ProForm.Group>
              <ProFormDigit name="middleLength" label="宽度" width="sm" />
              <ProFormDigit name="middleWidth" label="高度" width="sm" />
              <ProFormDigit name="middleHeight" label="深度" width="sm" />
            </ProForm.Group>
          </ProCard>
          <ProCard
            title="车尾信息"
          ...
          >
            <ProForm.Group>
              <ProFormDigit name="tailLength" label="宽度" width="sm" />
              <ProFormDigit name="tailWidth" label="高度" width="sm" />
              <ProFormDigit name="tailHeight" label="深度" width="sm" />
            </ProForm.Group>
          </ProCard>
        </ProCard>
